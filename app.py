...
if __name__ == '__main__':
    ...
    feature_freq = [{'coh' : 'alpha'}, { 'coh' : 'beta' }, {'coh' : 'theta'}]
    dataset = data_io.dataloader.RawDataset(sleep_stages=["N2"], feature_freq=feature_freq, hormones = ['BDC1'] + [f'BDC1.{i}' for i in range(1, 12)]) 
